...
class pengajar extends admin {
    ...
    function display($view_location) {
        $this->load->view('admin/pengajar/include', $this->data);
    ...
    public function data() {
        ...
        $this->display('admin/pengajar/data');
    }
    ...
    public function detail() {
        ...
        if ($get["results"][0] != "") {
            ...
            $image_dir = IMAGE_PATH . 'tpq/' . $get['results'][0]->id_tpq . '/pengajar/' . $get['results'][0]->foto;
            ...
            $this->display('admin/pengajar/detail');
        } else {
            redirect('/admin/404');
        }
    }
    ...
    public function add() {
        ...
        $view_location = 'admin/pengajar/add';
    ...
    public function add_submit() {
        ...
        $check = $this->data_model->get($params_email);
...
//            $result = response_success();
    ...
    public function delete_submit() {
        ...
        $delete_pengajar = $this->data_model->delete($params_delete_pengajar);
