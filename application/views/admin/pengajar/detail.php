                                ...
                                <div class="row clearfix">                                        
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group form-float form-group-md">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="datepicker form-control" placeholder="Please choose a date..." id="tgl_lahir" value="<?= $detail['data_pengajar'][0]->tgl_lahir ?>">
                                            </div>
                                        </div>  
                                    </div>
                                    <div class="col-md-5">
                                        <p><label class="form-label">Foto</label></p>                                                                         
                                        <img id="output_foto" style="width:60%" class="img img-thumbnail" src="<?= $detail['data_pengajar'][0]->foto ?>"/>
                                        <br><br>                                            
                                        <input type="file" accept="image/*" class="" name="foto" onchange="load(event)" id="foto">                                            
                                        <input type="hidden" id="foto_old" value='<?= $detail['data_pengajar'][0]->foto_old ?>'>                                                                                                                                                
                                ...
                                <div class="form-group form-float form-group-md">
                                    ...
                                    <select class="form-control" id="pdkn">
                                        ...
                                        if ($detail['data_pengajar'][0]->pdkn == 'DPL') {
                                            echo '<option value="DPL" selected>Diploma</option>';
                                        } else {
                                        ...
                                        if ($detail['data_pengajar'][0]->pdkn == 'SRJ') {
                                            echo '<option value="SRJ" selected>Sarjana</option>';
                                        } else {
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="aktif">
                                <div class="form-group form-float form-group-md">
                                    ...
                                    <select class="form-control" id="aktif_data">
                                        <?php
                                        if ($detail['data_pengajar'][0]->aktif == 'A') {
                                        ...
                                        ?>                                                                                        
                                        <?php
                                        if ($detail['data_pengajar'][0]->aktif == 'N') {
